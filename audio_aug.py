...
path = 'cv-corpus-11.0-2022-09-21/ar/clips'
new_path = path + '/augmented_BandStop_audio' #for every type of augment change name here
os.makedirs(new_path) #only once creates directory
mp3_pre_augment = glob.glob('cv-corpus-11.0-2022-09-21/ar/clips/*mp3') #switch with path to location of mp3 files
